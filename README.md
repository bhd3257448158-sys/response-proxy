...
[Codex CLI](https://github.com/openai/codex) 是 OpenAI 出品的终端 AI 编程助手，但它**只支持 OpenAI 官方的 API**。如果你想让 Codex CLI 使用其他大模型（DeepSeek、智谱 GLM、Kimi、通义千问、豆包、MiniMax，或任何 OpenAI 兼容 API），就需要一个"翻译官"——这就是 `response-proxy`。
