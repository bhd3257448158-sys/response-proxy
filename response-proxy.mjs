...
async function runWizard(presets, { skipContinuePrompt = false, port = 9090 } = {}) {
  ...
  const providers = [
    ...
    { key: "5", name: "Kimi Coding Plan", preset: "kimicp", defaultModel: "k2p5" },
    { key: "6", name: "通义千问", preset: "qwen", defaultModel: "qwen-max" },
    { key: "7", name: "百炼 Coding Plan", preset: "qwencp", defaultModel: "qwen3.6-plus" },
    { key: "8", name: "豆包（火山引擎）", preset: "doubao", defaultModel: "doubao-seed-1.5" },
    { key: "9", name: "方舟 Coding Plan", preset: "doubaocp", defaultModel: "ark-code-latest" },
    { key: "a", name: "MiniMax", preset: "minimax", defaultModel: "minimax-m2.5" },
    { key: "b", name: "MiniMax Coding Plan", preset: "minimaxcp", defaultModel: "minimax-m2.7" },
    { key: "c", name: "Ollama（本地，免费）", preset: "ollama", defaultModel: "qwen2.5-coder:7b" },
    { key: "d", name: "其他（自定义 URL）", preset: null, defaultModel: "" },
  ];
...
if (args.includes("--setup")) {
  const _PRESETS = {
    ...
    kimicp: "https://api.kimi.com/coding",
